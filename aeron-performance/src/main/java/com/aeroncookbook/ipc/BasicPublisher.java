...
public class BasicPublisher
{
    ...
    private static final String CHANNEL = "aeron:udp?endpoint=localhost:8080";
    ...
    public static void main(final String[] args) throws InterruptedException
    {
        ...
        sendingMessages(CHANNEL, STREAM_ID, NUMBER_OF_MESSAGES);
    ...
    public static void sendingMessages(String CHANNEL, int STREAM_ID, long NUMBER_OF_MESSAGES) {
    ...
    public static void closeConnection(){
        CloseHelper.close(isEmbeddedMediaDriver());
